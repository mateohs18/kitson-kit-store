        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              ...
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 animate-float" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 animate-float" style={{ animationDelay: '0.4s' }}>
                <Users className="w-12 h-12 text-secondary mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-foreground mb-2">+2 Años</h3>
